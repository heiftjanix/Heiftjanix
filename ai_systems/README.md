...
- 🔁 **Feedback & Weiterentwicklung statt Neubau:** Jeder Mitarbeiter hat einen
  **fortlaufenden Chat-Verlauf** (wachsender Kontext), und Claude bekommt die
  **letzten Läufe inkl. Fehlermeldungen** automatisch als Feedback — „der
  gestrige Lauf ist fehlgeschlagen, bitte fixen" reicht.
...
- 🩺 **Diagnose-Seite:** Der Knopf „Diagnose" oben rechts prüft auf einen Klick
...
- 🧠 **Modell direkt im Chat wählbar:** Oben im Chat-Fenster lässt sich das
  ...
  Claude-Fehler werden im Klartext angezeigt (z. B. „Kein Guthaben mehr" oder
  „Modell nicht verfügbar") statt als kryptische Meldung.
...
damit der Cross-Build ohne Signatur-Schritt läuft).
