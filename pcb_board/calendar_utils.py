...
1:1-Port von scripts/lib/calendar_utils.py im Hauptrepo. Diese App läuft in der
Bench-Umgebung des Kunden ohne Zugriff auf das Repo, daher liegt die Logik hier
als eigenständige Kopie. Bei Formeländerungen im Original bitte hier nachziehen.
"""
